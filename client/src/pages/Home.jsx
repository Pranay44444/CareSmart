  ...
  return (
    <div style={styles.page}>
      <section style={styles.hero}>
        <span style={styles.badge} className="gold-glow">
          Premium Care
        </span>
        <h1 style={styles.h1} className="font-playfair">
          Protect Your Device,
          <br />
          Extend Its Legacy
        </h1>
        ...
        <div style={styles.btnRow}>
          ...
          <Link to="/register" style={styles.btnSecondary} className="gold-glow">
            Join the Waitlist
          </Link>
        </div>
      ...
      <section style={{ ...styles.section, marginTop: '-40px', position: 'relative', zIndex: 20 }}>
        <h2 style={styles.sectionTitle} className="font-playfair">
          The CareSmart Difference
        </h2>
        <p style={styles.sectionSub}>
          Everything you need to keep your device running at its pinnacle.
        </p>
        <div style={styles.grid}>
          {features.map((f, i) => (
            <div
              ...
              className="glass-panel skeuo-shadow gold-glow float-anim"
            >
